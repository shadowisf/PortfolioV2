    ...
    content: (
      <Fragment>
        ...
        <p>
          ...
          <u>projects, life history, research, and all things me!</u> but now
          with better optimization, design, animations, and a cleaner aesthetic.
        </p>
        ...
        <h6>core concept:</h6>
        <p>
          portfolio v2 is centered around green sock animation platform (gsap),
          an animation framework for javascript (and/or typescript). through
          this, it gave me more freedom and control in animating html elements
          through javascript, rather than sticking to pure css. additionally, my
          react concepts were expanded further than portfolio v1, such concepts
          are contexts, react routers, and portals.
        </p>
    ...
    content: (
      <Fragment>
        ...
        <p>
          ...
          page repeatedly. additionally, there are states, hooks, props, and a
          lot more.
        </p>
        ...
        <h6>my role:</h6>
        <p>
          portfolio v1 was a solo project. every tech stack was implemented by
          me.
        </p>
      </Fragment>
    ),
    ...
    content: (
      <Fragment>
        ...
        <p>
          ...
          2022, version control via git, and all things .net or microsoft
          related; hence most of the tech stack are frameworks/applications by
          microsoft.
        </p>
    ...
    content: (
      <Fragment>
        ...
        <p>
          ...
          within the xampp database. additionally, it has a login system for
          three user types (receptionist, doctor, staff), error handling, input
        ...
        <h6>core concept:</h6>
        <p>
          apollo hospital is centered around software engineering principles
          such as software development life cycle (sdlc). in which engineers use
          models to represent processes such as project planning, development,
        ...
        <p>
          ...
          front-end: overall theme, buttons, navbar, modals, webpages via html,
          bootstrap css and javascript. additionally, i implemented half of the
          back-end: database schema via xampp, error handling, and callouts via
          django.
        </p>
      </Fragment>
    ),
    ...
    content: (
      <Fragment>
        ...
        <p>
          ...
          students. its system features a login system for one user type
          (students) and a menu that features all mathematical operations a
          student needs; arithmetics, fibonacci sequences, area of different
          shapes, etc. the design aesthetic for this project was heavily
          inspired by vibrant pixel art and sprites.
        </p>
        ...
        <p>
          ...
          back-end or math operations: factorial, fibonacci, average, and
          min/max via java.
        </p>
      </Fragment>
    ),
    ...
    content: (
      <Fragment>
        ...
        <p>
          ...
          to be used with a command line interface (cli). it covers handling
          entity (patient and doctor) information, appointment scheduling, and
          managing of pharmaceutical information. its system feature crud
          operations: create, read, update, and delete via file handling, this
          means that data is stored in a .txt file in a local directory.
          additionally, it has error handling and persistent data after program
          reload.
        </p>
        ...
        <p>
          ...
          java. this means creating objects and methods to be repeatedly
